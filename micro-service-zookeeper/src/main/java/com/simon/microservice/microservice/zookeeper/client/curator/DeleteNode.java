...
public class DeleteNode {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Stat stat = new Stat();
        System.out.println(new String(build.getData().storingStatIn(stat).forPath("/simon/simons")));

        build.delete().deletingChildrenIfNeeded().withVersion(stat.getVersion()).forPath("/simon/simons");
    }
}
